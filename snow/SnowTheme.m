...
- (void)azure {
  ...
  _primary =  [UIColor colorWithRed:.99 green:.25 blue:.25 alpha:1]; // [UIColor colorWithRed:0 green:.498 blue:1 alpha:1];
 // _secondary = [UIColor colorWithRed:0 green:.18 blue:.386 alpha:1];
...
- (void)sunny {
 ...
 // _textColor = kSnowColor_WHITE_OPAQUE;
  ...
  _primary = [UIColor colorWithRed:.1 green:.9 blue:.6 alpha:1];
    ...
    _secondary = [UIColor whiteColor]; // [UIColor colorWithRed:.32 green:.31 blue:.11 alpha:1];
